...
const STRINGS = {
  es: {
    ...
    bones: 'Huesos',
    search: 'Buscar',
    search_ph: 'Buscar: bíceps, espalda, glúteo…',
    hud: 'Arrastrar = rotar · Rueda = zoom · Clic = seleccionar · Doble clic = enfocar',
    ...
    about_model: 'Modelos anatómicos 3D: Z-Anatomy y AnatomyTool Open3DModel (CC BY-SA 4.0), derivados de BodyParts3D.',
    ...
    hud_touch: 'Arrastrar = rotar · Pellizcar = zoom · Tocar = seleccionar · Doble toque = enfocar',
    ...
    exercise_search_ph: 'Buscar ejercicio o grupo…',
  ...
  en: {
    ...
    bones: 'Bones',
    search: 'Search',
    search_ph: 'Search: biceps, back, glutes…',
    hud: 'Drag = rotate · Wheel = zoom · Click = select · Double-click = focus',
    reset: 'Reset view',
    fit: 'Fit',
    ...
    about_model: '3D anatomical models: Z-Anatomy and AnatomyTool Open3DModel (CC BY-SA 4.0), derived from BodyParts3D.',
    ...
    close: 'Close',
    info_panel: 'Info',
    hud_touch: 'Drag = rotate · Pinch = zoom · Tap = select · Double-tap = focus',
    ...
    exercise_search_ph: 'Search exercise or group…',
