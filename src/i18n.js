...
const STRINGS = {
  es: {
    ...
    wiki_chat_open: 'Pregúntale a la Wiki',
    wiki_chat_title: 'WIKI MAZOTHECOACH',
    wiki_chat_ph: 'Ej: ¿dónde debería sentir el RDL?',
    wiki_chat_send: 'Enviar',
    wiki_chat_hello: '¡Hola! Soy la wiki del visor. Pregúntame sobre músculos, ejercicios, rangos de movimiento o dónde deberías sentir un ejercicio.',
    wiki_chat_thinking: 'Pensando…',
    wiki_chat_limited: 'Llegaste al límite de preguntas por ahora. Intenta de nuevo en ~{min} min, o sigue en NotebookLM.',
    wiki_chat_error: 'No pude conectar con la wiki ahora mismo. Pregunta directo en el notebook:',
    wiki_chat_offline: 'El chat aún no está activo. Mientras tanto pregunta en el notebook:',
    wiki_chat_disclaimer: 'Educativo, no es consejo médico. Puede cometer errores.',
    wiki_chat_reset: 'Restablecer posición y tamaño',
    wiki_chat_see: 'Ver en el modelo 3D →',
  ...
  en: {
    ...
    wiki_chat_open: 'Ask the Wiki',
    wiki_chat_title: 'MAZOTHECOACH WIKI',
    wiki_chat_ph: 'e.g. where should I feel RDLs?',
    wiki_chat_send: 'Send',
    wiki_chat_hello: 'Hi! I\'m the viewer\'s wiki. Ask me about muscles, exercises, ranges of motion, or where you should feel an exercise.',
    wiki_chat_thinking: 'Thinking…',
    wiki_chat_limited: 'You hit the question limit for now. Try again in ~{min} min, or continue in NotebookLM.',
    wiki_chat_error: 'Couldn\'t reach the wiki right now. Ask directly in the notebook:',
    wiki_chat_offline: 'The chat isn\'t live yet. Meanwhile, ask in the notebook:',
    wiki_chat_disclaimer: 'Educational, not medical advice. It can make mistakes.',
    wiki_chat_reset: 'Reset position & size',
    wiki_chat_see: 'See it on the 3D model →',
